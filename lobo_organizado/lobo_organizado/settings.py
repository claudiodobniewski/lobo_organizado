"""
Django settings for lobo_organizado project.
...
SECRET_KEY = '5!0m-1s+_g7nkj367&#qvjbbbiz2!jkvuu2e+4w^@o5rhk(j5='
...
ROOT_URLCONF = 'lobo_organizado.urls'
...
WSGI_APPLICATION = 'lobo_organizado.wsgi.application'
...
# https://devcode.la/tutoriales/internacionalizacion-en-django/
LOCALE_PATHS = (
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'formatter': 'verbose',
            'filename': BASE_DIR / "logs/lobo_organizado.log",
            'when': 'midnight',
            'backupCount': '30',
        }
    },
